            ...
            <div class="col-md-7">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="basic-layout-form">Testimonial Info</h4>
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            <form class="form" enctype="multipart/form-data" method="post" action="{{ route('admin.testimonial.store') }}">
                                @csrf
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-12">
