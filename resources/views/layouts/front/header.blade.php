<header data-elementor-type="header" data-elementor-id="23" class="elementor elementor-23 elementor-location-header"
    ...
    <div class="elementor-element elementor-element-53a6263e elementor-hidden-mobile e-flex e-con-boxed e-con e-parent"
        data-id="53a6263e" data-element_type="container" data-e-type="container"
        data-settings='{"background_background":"classic"}'>
        <div class="e-con-inner">
            <div class="elementor-element elementor-element-192f0395 e-con-full e-flex e-con e-child" data-id="192f0395"
                data-element_type="container" data-e-type="container">
                <div class="elementor-element elementor-element-5b7ba737 e-con-full e-flex e-con e-child"
                    data-id="5b7ba737" data-element_type="container" data-e-type="container">
                    <div class="elementor-element elementor-element-5ff411f4 elementor-icon-list--layout-inline elementor-hidden-desktop elementor-hidden-tablet elementor-hidden-mobile elementor-list-item-link-full_width elementor-widget elementor-widget-icon-list"
                        data-id="5ff411f4" data-element_type="widget" data-e-type="widget"
                        data-widget_type="icon-list.default">
                        <div class="elementor-widget-container">
                            <ul class="elementor-icon-list-items elementor-inline-items">
                                <li class="elementor-icon-list-item elementor-inline-item"> <a
                                        href="mailto:info@domain.com"> <span class="elementor-icon-list-icon">
                                            ...
                                            </svg> </span> <span class="elementor-icon-list-text">info@domain.com</span>
                                    </a> </li>
                                <li class="elementor-icon-list-item elementor-inline-item"> <a href="tel:+1234567890">
                                        <span class="elementor-icon-list-icon">
                                            ...
                                            </svg> </span> <span class="elementor-icon-list-text">+123 456
                                            7890</span> </a> </li>
                                <li class="elementor-icon-list-item elementor-inline-item"> <span
                                        ...
                                        </svg> </span> <span class="elementor-icon-list-text">Lorem Ipsum
                                        123</span> </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="elementor-element elementor-element-d6be263 e-con-full elementor-hidden-tablet elementor-hidden-mobile e-flex e-con e-child"
                    ...
                    <div class="elementor-element elementor-element-5749e0ee e-grid-align-right elementor-shape-rounded elementor-grid-0 elementor-widget elementor-widget-social-icons"
                        data-id="5749e0ee" data-element_type="widget" data-e-type="widget"
    ...
    <div class="elementor-element elementor-element-368264ea e-flex e-con-boxed e-con e-parent" data-id="368264ea"
        data-element_type="container" data-e-type="container" data-settings='{"background_background":"classic"}'>
        <div class="e-con-inner">
            <div class="elementor-element elementor-element-77901143 e-con-full e-flex e-con e-child" data-id="77901143"
                data-element_type="container" data-e-type="container">
                <div class="elementor-element elementor-element-3c13051 elementor-widget elementor-widget-heading"
                    data-id="3c13051" data-element_type="widget" data-e-type="widget"
                    data-widget_type="heading.default">
                    <div class="elementor-widget-container">
                        <h6 class="elementor-heading-title elementor-size-default">Dr. Gil Gockley</h6>
                    </div>
                </div>
            </div>
            <div class="elementor-element elementor-element-2d5eee95 e-con-full e-flex e-con e-child"
                data-id="2d5eee95" data-element_type="container" data-e-type="container">
                <div class="elementor-element elementor-element-2313ca7d elementor-nav-menu__align-center elementor-nav-menu--stretch elementor-nav-menu__text-align-center elementor-nav-menu--dropdown-tablet elementor-nav-menu--toggle elementor-nav-menu--burger elementor-widget elementor-widget-nav-menu"
                    data-id="2313ca7d" data-element_type="widget" data-e-type="widget"
                    ...
                    <div class="elementor-widget-container">
                        <nav aria-label="Menu"
                            ...
                            <ul id="menu-1-2313ca7d" class="elementor-nav-menu">
                                <li
                                    class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-54 current_page_item menu-item-64">
                                    <a href="{{route('home')}}" aria-current="page"
                                        class="elementor-item elementor-item-active">Home</a>
                                </li>
                                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1235">
                                    <a href="{{route('about')}}" class="elementor-item">About the Author</a>
                                </li>
                                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1236">
                                    <a href="{{route('book')}}" class="elementor-item">About the Book</a>
                                </li>
                                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1237">
                                    <a href="{{route('blog')}}" class="elementor-item">Blogs</a>
                                </li>
                                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1238">
                                    <a href="{{route('contact')}}" class="elementor-item">Contact Me</a>
                                </li>
                            </ul>
                        </nav>
                        ...
                        <nav class="elementor-nav-menu--dropdown elementor-nav-menu__container" aria-hidden="true">
                            <ul id="menu-2-2313ca7d" class="elementor-nav-menu">
                                <li
                                    class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-54 current_page_item menu-item-64">
                                ...
                                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1235">
                                    <a href="{{route('about')}}" class="elementor-item" tabindex="-1">About the
                                        Author</a>
                                </li>
                                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1236">
                                    <a href="{{route('book')}}" class="elementor-item" tabindex="-1">About the
                                        Book</a>
                                </li>
                                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1237">
                                    <a href="{{route('blog')}}" class="elementor-item" tabindex="-1">Blogs</a>
                                </li>
                                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1238">
                                    <a href="{{route('contact')}}" class="elementor-item" tabindex="-1">Contact Me</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
            ...
            <div class="elementor-element elementor-element-7e58dc5e e-con-full elementor-hidden-tablet elementor-hidden-mobile e-flex e-con e-child"
                data-id="7e58dc5e" data-element_type="container" data-e-type="container">
                <div class="elementor-element elementor-element-4f600436 elementor-tablet-align-center elementor-align-right elementor-widget elementor-widget-button"
                    data-id="4f600436" data-element_type="widget" data-e-type="widget"
